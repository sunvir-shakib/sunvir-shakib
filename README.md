...
|--------|-------------|------|
| [guardian_defense](https://github.com/sunvir-shakib/guardian_defense) | Real-time AI agent for strategic defensive decision-making | Python |
| [smart-notice](https://github.com/sunvir-shakib/smart-notice) | Smart notice management app | Kotlin |
| [airline-reservation-system](https://github.com/sunvir-shakib/airline-reservation-system) | Airline ticket reservation system | JavaScript |
| [library-management-system](https://github.com/sunvir-shakib/library-management-system-oop-final-lab-) | OOP-based library management system | Java |
| [internet-programming-project](https://github.com/sunvir-shakib/internet-programming-final-lab-project) | Final lab project for internet programming | PHP |
...
- 🎣 I fish. Patience is a skill, in code and on the water.
- 🛍️ I shop. Finding the right thing takes research — just like debugging.
- 💬 I gossip with close friends. Good conversations spark good ideas.
